...
public sealed class PromptResolverTests
{
    ...
    private PromptResolver CreateResolver()
    {
        ...
        return new PromptResolver(
            _store.Object, settings.Object, _foregroundApp.Object,
    ...
    [Fact]
    public void Resolve_ModeTemperature_OverridesSettings()
    {
        _appSettings.Llm.Temperature = 0.7;
    ...
    [Fact]
    public void Resolve_NoModeTemperature_UsesSettingsTemperatureAndMaxTokens()
    {
        _appSettings.Llm.Temperature = 0.7;
        _appSettings.Llm.MaxTokens = 1234;
